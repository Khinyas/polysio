...
public class ViewPropriete extends VBox {
    ...
    public ViewPropriete(ModelPropriete modelProprieteP) {
        ...
        String chemin = modelProprieteP.getCheminSvg();
        ...
        try {
            ...
            if (resource != null) {
                ...
                this.getChildren().add(new Label(modelProprieteP.getNom()));
            }

        } catch (Exception e) {
            System.out.println("ERREUR Exception sur la case : " + modelProprieteP.getNom());
