...
public class BoutonDeconnexion extends Button {
    ...
    public BoutonDeconnexion () {
        ...
        this.setOnAction(event -> {
            System.out.println("Direction la Déconnexion !");
            ControllerConnexion.validerDeconnexion();
