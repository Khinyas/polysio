...
public class BoutonPaiement extends Button {
    private Label labelResultat = new Label("Payer Le Loyer");
    ...
    public BoutonPaiement() {
        super("Payer Le Loyer");
        this.setStyle(STYLE_BASE);
        this.setCursor(javafx.scene.Cursor.HAND);
        try {
            String path = getClass().getResource("/audio/coin-1.mp3").toExternalForm();
